...
export function ModeToggle() {
  ...
  return (
    <Button
      ...
      className="rounded-full w-9 h-9 border border-transparent hover:bg-secondary/80 bg-background/50 backdrop-blur-md transition-colors duration-500 ease-in-out"
    >

          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <FieldGroup className="gap-6">
                  <Field>
                    <FieldLabel htmlFor="signup-email" className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground/80">
                      Email address
                    </FieldLabel>
                    <Input
                      id="signup-email"
            ...
            {step === 3 && (
              ...
              >
                ...
                <FieldGroup className="gap-6">
                  <Field>
                    <FieldLabel htmlFor="signup-password" className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground/80">
                      Password
                    </FieldLabel>

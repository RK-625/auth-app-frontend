...
export default function LoginForm({
  ...
  const isReady = email.length > 0 && password.length >= 6 && password.length <= 15
        ...
        <div className="flex flex-col justify-center p-8 sm:p-12 md:p-14 bg-card/30">
          ...
          <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
            ...
            <FieldGroup className="gap-6">
              <Field>
                <FieldLabel htmlFor="login-email" className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground/80">
                  Email
                </FieldLabel>
                <Input
                  id="login-email"
              ...
              <Field>
                <div className="flex items-center justify-between">
                  <FieldLabel htmlFor="login-password" className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground/80">
                    Password
                  </FieldLabel>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Button
                  ...
                  className="h-11 bg-transparent hover:bg-muted/50"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className="mr-2 size-4">
